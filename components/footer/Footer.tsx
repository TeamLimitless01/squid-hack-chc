      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 lg:gap-8 mb-16">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-600 mb-8 max-w-sm leading-relaxed">
              Connecting farmers with reliable agricultural services, equipment, and operators to modernize Indian agriculture.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><Link href="/services" className="text-gray-600 hover:text-brand-600 transition-colors">Services</Link></li>
              <li><Link href="#how-it-works" className="text-gray-600 hover:text-brand-600 transition-colors">How It Works</Link></li>
              <li><Link href="/search" className="text-gray-600 hover:text-brand-600 transition-colors">Find a CHC</Link></li>
              <li><Link href="/pricing" className="text-gray-600 hover:text-brand-600 transition-colors">Pricing</Link></li>
            </ul>
          </div>

          <div>
            <h4 className="font-semibold text-gray-900 mb-6">For CHCs</h4>
            <ul className="space-y-4">
              <li><Link href="/register/chc" className="text-gray-600 hover:text-brand-600 transition-colors">Become a CHC</Link></li>
              <li><Link href="/dashboard" className="text-gray-600 hover:text-brand-600 transition-colors">Manage Services</Link></li>
              <li><Link href="/dashboard/fleet" className="text-gray-600 hover:text-brand-600 transition-colors">Fleet Management</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><Link href="/support" className="text-gray-600 hover:text-brand-600 transition-colors">Contact Support</Link></li>
              <li><Link href="/faq" className="text-gray-600 hover:text-brand-600 transition-colors">FAQs</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-6 text-sm text-gray-500">
            ...
            <Link href="/cookies" className="hover:text-brand-600 transition-colors">Cookies</Link>
          </div>
        </div>
      </div>
    </footer>
